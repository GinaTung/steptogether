<template>
  <div class="flex justify-between items-center m-3">
    <div class="flex item-center">
      <Button icon="pi pi-bars" @click="toggleMenu"
        class="text-white bg-[#EF6C00] rounded-lg hover:bg-gradient-to-r hover:from-[#272F43] hover:to-[#1B2230] transition-all duration-300 p-2 cursor-pointer"
        unstyled />
    ...
    <div class="flex justify-between w-100">
      <InputText placeholder="Search" type="text" class="w-[250px] border border-black rounded-md px-2" unstyled />

      <Button label="SHORE POST"
        class="p-2 text-white bg-[#EF6C00] rounded-lg hover:bg-gradient-to-r hover:from-[#272F43] hover:to-[#1B2230] transition-all duration-300 cursor-pointer"
        unstyled />
    </div>
          ...
          <template #start>
            <div class="flex items-center gap-3 mx-3 border-b-1 py-3 border-[#94a3b8]">
              ...
              <span class="inline-flex flex-col items-start">
                  ...
                  <span class="text-sm">@douejohn</span>
              </span>
            </div>
